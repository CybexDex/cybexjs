...
Pure JavaScript Cybex library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.
...
var {ChainStore} = require("CybexJS");

Apis.instance("wss://Cybex.openledger.info/ws", true).init_promise.then((res) => {
...
```
var {PrivateKey, key} = require("CybexJS");
...
#### Transactions
```
var { TransactionBuilder,ops,Signature,PrivateKey} = require("cybexjs")
let tr = new TransactionBuilder()
tr.add_type_operation(type_name, obj)
await tr.update_head_block()
tr.set_expire_seconds(30)
tr.add_signer(PrivateKey.fromWif(wifKey))
