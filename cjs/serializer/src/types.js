...
Types.uint64 = {
  ...
  appendByteBuffer(b, object) {
    b.writeUint64(_SerializerValidation.default.to_long(_SerializerValidation.default.unsigned(object)));
    return;
  },

  fromObject(object) {
    return _SerializerValidation.default.to_long(_SerializerValidation.default.unsigned(object));
  },
...
Types.time_point_sec = {
  ...
  fromObject(object) {
    ...
    if (typeof object !== "string") throw new Error("Unknown date type: " + object); // if(typeof object === "string" && !/Z$/.test(object))
    //     object = object + "Z"
...
Types.public_key = {
  ...
  toObject(object, debug = {}) {
    if (debug.use_default && object === undefined) {
      return _cybexjsWs.ChainConfig.address_prefix + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
    }
...
Types.address = {
  ...
  toObject(object, debug = {}) {
    if (debug.use_default && object === undefined) {
      return _cybexjsWs.ChainConfig.address_prefix + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
    }
